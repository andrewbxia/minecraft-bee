...
if (ENVIRONMENT_IS_SHELL) {
  ...
  const isNode = typeof process == 'object' && ((_process$versions = process.versions) === null || _process$versions === void 0 ? void 0 : _process$versions.node) && process.type != 'renderer';
...
function findWasmBinary() {
  return locateFile('untangle.wasm');
}
...
var _restore_puzzle_size = Module['_restore_puzzle_size'] = makeInvalidEarlyAccess('_restore_puzzle_size');
var _mousedown = Module['_mousedown'] = makeInvalidEarlyAccess('_mousedown');
var _mouseup = Module['_mouseup'] = makeInvalidEarlyAccess('_mouseup');
var _mousemove = Module['_mousemove'] = makeInvalidEarlyAccess('_mousemove');
var _key = Module['_key'] = makeInvalidEarlyAccess('_key');
var _dlg_return_sval = Module['_dlg_return_sval'] = makeInvalidEarlyAccess('_dlg_return_sval');
var _dlg_return_ival = Module['_dlg_return_ival'] = makeInvalidEarlyAccess('_dlg_return_ival');
...
function assignWasmExports(wasmExports) {
  ...
  Module['_timer_callback'] = _timer_callback = createExportWrapper('timer_callback', 1);
  Module['_rescale_puzzle'] = _rescale_puzzle = createExportWrapper('rescale_puzzle', 0);
  Module['_resize_puzzle'] = _resize_puzzle = createExportWrapper('resize_puzzle', 2);
  Module['_restore_puzzle_size'] = _restore_puzzle_size = createExportWrapper('restore_puzzle_size', 2);
  Module['_mousedown'] = _mousedown = createExportWrapper('mousedown', 3);
  Module['_mouseup'] = _mouseup = createExportWrapper('mouseup', 3);
  Module['_mousemove'] = _mousemove = createExportWrapper('mousemove', 3);
  Module['_key'] = _key = createExportWrapper('key', 6);
  Module['_dlg_return_sval'] = _dlg_return_sval = createExportWrapper('dlg_return_sval', 2);
  Module['_dlg_return_ival'] = _dlg_return_ival = createExportWrapper('dlg_return_ival', 2);
  Module['_command'] = _command = createExportWrapper('command', 1);
  Module['_get_text_format'] = _get_text_format = createExportWrapper('get_text_format', 0);
  Module['_free_text_format'] = _free_text_format = createExportWrapper('free_text_format', 1);
  Module['_get_save_file'] = _get_save_file = createExportWrapper('get_save_file', 0);
  Module['_free_save_file'] = _free_save_file = createExportWrapper('free_save_file', 1);
  Module['_load_game'] = _load_game = createExportWrapper('load_game', 0);
  Module['_prefs_load_callback'] = _prefs_load_callback = createExportWrapper('prefs_load_callback', 2);
